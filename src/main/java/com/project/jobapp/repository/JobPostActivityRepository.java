...
import com.project.jobapp.entity.IRecruiterJobs;
...
public interface JobPostActivityRepository extends JpaRepository<JobPostActivity, Integer> {
    ...
    //Retrieve list of jobs for a given recruiter id
    //Combines/joins job post activity, job location, company
    //Also includes a count of job seekers/candidates who have applied fo a given job
